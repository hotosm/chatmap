...
import { MAX_OPTIONS, MIN_OPTIONS } from "../../utils/botSetup.js";

// One shell for every kind of message. Only single choice questions edit a
// list of options; the rest are a single message.
